...
CrGrpsRepsLSZ2 <- CrGrpsReps %>% 
  filter(event =="LSZ2")
## this aes allows the x axis to be ordered in descending order of the y-axis
a <- ggplot(data=CrGrpsLSZ2, aes(x=reorder(group_size, -crMnCpm),  y=crMnCpm))+#aes(group_size, crMnCpm)) +
